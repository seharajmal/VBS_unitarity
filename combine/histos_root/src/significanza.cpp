...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mjj_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mjj_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mjj_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mjj_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mjj_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mjj_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mll_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mll_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mll_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mll_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~mll_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double mll_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_el_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_el_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_el_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_el_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_el_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptel_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_mu_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_mu_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_mu_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_mu_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_mu_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptmu_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_tau_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_tau_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_tau_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_tau_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_tau_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptta_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_j_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_j_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_j_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_j_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~PT_j_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double ptj_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_el_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_el_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_el_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_el_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_el_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etael_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_mu_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_mu_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_mu_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_mu_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_mu_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etamu_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_tau_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_tau_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_tau_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_tau_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_tau_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etata_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_j_cW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_j_cHW~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHW_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHW_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHW_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHW_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_j_cHWB~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHWB_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHWB_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHWB_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHWB_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_j_cHbox~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHbox_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHbox_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHbox_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHbox_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Eta_j_cHDD~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHDD_lin = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
  
  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHDD_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));

  h1 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM_cHDD_int_quad");
  h0 = (TH1F*) f->Get("SR_inclusive_2017/VBS_SSWW_SM");
  n1 = h1->Integral();
  n0 = h0->Integral();
  double etaj_cHDD_lin_quad = sqrt(2*n1*log(1+(n1-n0)/n0)-2*(n1-n0));
