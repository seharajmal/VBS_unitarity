...
///////////////// FINE CONFIG
   ...
   char name[50];
   sprintf(name,"histos4datacards/plots/%s/%s_%s.png",argv[1],argv[2],argv[1]);
...
//	  }
	...
	//h1->GetYaxis()->SetRangeUser(0,250); //per prova mll con cW
 ...
 TLegend *leg = new TLegend(0.38, 0.75, 0.69, 0.89);
